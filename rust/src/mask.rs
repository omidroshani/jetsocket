...
//! This module provides optimized masking using word-at-a-time operations.

use pyo3::prelude::*;
use pyo3::types::PyBytes;

/// Apply WebSocket masking to data in place.
///
/// The masking algorithm is:
///   j = i MOD 4
///   transformed[i] = original[i] XOR mask[j]
///
/// This implementation processes data in 8-byte chunks for better performance
/// on 64-bit systems.
#[pyfunction]
...
pub fn apply_mask_inplace(data: &mut [u8], mask: [u8; 4]) {
    ...
    // Create a 64-bit mask by repeating the 4-byte mask twice
